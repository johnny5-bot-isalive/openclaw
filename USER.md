...
- **Notes:**
  ...
  - Any reference to another markdown page or a website should be a clickable markdown link.
  - For inbox-facing notes, final reports, and other high-read deliverables, prefer concise visual markdown only when it materially improves scanability.
